...
public class SafeLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"USE", "TYPE", "UNIT", "PREFIX", "WRITE", "WRITELN", "READ", "FORMAT", 
			...
			"REAL_LITERAL", "INTEGER_LITERAL", "STRING_LITERAL", "ID", "DIGIT", "LETTER", 
			"EXPONENT", "ESC_SEQ", "MULTILINE_COMMENT", "LINE_COMMENT", "WS"
		};
	}
	...
	public SafeLangLexer(CharStream input) {
		super(input);
